...
class _LoginScreenState extends State<OwnerLoginScreen>
  ...
  // Owner uses Gym ID instead of Gmail
  ...
  void _handleLogin() {
     ...
     * IMPORTANT:
     *
     * LoginMixin currently expects the first controller
     * as "emailCtrl".
     *
     * We are passing _gymIdCtrl here because the Owner now
     * logs in using Gym ID instead of Gmail.
     *
        ...
        return Opacity(
          ...
          child: Column(
            children: [
              ...
              GestureDetector(
                onTap: () {
                  context.pushNamed('purchaseMembership');
                },
                child: Container(
                  width: double.infinity,
                  height: 50,
