...
class _TrainerLoginScreenState extends State<TrainerLoginScreen>
  ...
  // ── Shield colors ──
  static const _outerShield = [Color(0xFFEE9D2D), Color(0xFF6B4A0F)];
  static const _innerShield = [Color(0xFF2A1A08), Color(0xFF120A03)];
  static const _buttonGradient = [Color(0xFFFFB31A), Color(0xFF8B6415)];
  static const Color _buttonTextColor = Color(0xFF1A0F00);
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          "trainer account and share your login "
